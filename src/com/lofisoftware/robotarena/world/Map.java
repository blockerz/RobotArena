...
public class Map {
	...
	public static final int ROOM_MIN_SIZE = 10;
	/** The maximum size of any room that will be genereated */
	public static final int ROOM_MAX_SIZE = 20;
	
	public static final int ID_LAYER = 0;
	public static final int FILL_LAYER = 1;
	public static final int PATHING_LAYER = 2;
	 ...
	 */
	public void generate(int minRooms) {
	 ...
	 * Get a list of rooms
	 * 
	 * @return The room list which has null rooms
	 */
	...
	public int getRandomValidRoomID() {
		int i = 0;
		while (i++ < roomCount) {
			int r = random.nextInt(roomCount);
			if (rooms[r] != null)
				return r;
		}
		return -1;
