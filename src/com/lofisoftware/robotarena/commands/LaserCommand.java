...
public class LaserCommand implements Command {
	...
	public LaserCommand (PooledEngine engine, Entity entity, Direction direction) {
	...
	public void execute() {
		...
		if (victim != null)
			MessageDispatcher.getInstance().dispatchMessage(null, Messages.DAMAGE, new DamageMessage(victim, entity, LASER_DAMAGE));
